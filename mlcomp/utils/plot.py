...
def heatmap(AUC, xlabel, ylabel, xticklabels, yticklabels, figure_width=40, figure_height=20,
...
def plot_classification_report(classification_report, cmap='RdBu'):
    ...
    return heatmap(np.array(plotMat), xlabel, ylabel, xticklabels, yticklabels, figure_width, figure_height,
